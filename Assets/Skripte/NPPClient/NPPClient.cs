...
/// <summary>
/// This class is used to fetch the state of the NPP simulation from the REST server and update the simulation state as well as the state machine.
/// </summary>
public class NPPClient : MonoBehaviour
{
	///<param name="client">HttpClient</param>
    private static readonly HttpClient client = new HttpClient();
	///<param name="simulation">NPPReactorState storing the current state of all components in the simulation</param>
    public NPPReactorState simulation = new NPPReactorState();
	///<param name="scenario">int specifying the scenario the user has chosen (0: no scenario chosen)</param>
	private int scenario = 0;
	///<param name="loadscenario">boolean tracking whether a scenario is currently being loaded</param>
	private Boolean loadscenario = false;
	///<param name="animatorController">Reference to the AnimatorController</param>
    private AnimatorController animatorController;
	///<param name="ausfallAnzeigenManager">Reference to the AusfallAnzeigenManager</param>
	...
	/// <summary>
	/// This method is called every frame to check for component failures and update the failure lamps.
	/// </summary>
    private void Update()
    {
	...
	/// <summary>
	/// This method fetches the JSON data from the REST server.
	/// </summary>
	/// <param name="url">string containing the server url</param>
    private async Task<string> GetJsonAsync(string url)
    {
        try {
			...
			Debug.LogError("Error fetching JSON data: " + e.Message);
        }
        return null;        
    }
	...
	/// </summary>
	/// <param name="id">string containing the pump id</param>
	/// <param name="value">int specifying the target RPM </param>
	...
	/// </summary>
	/// <param name="valveId">string containing the valve id</param>
	/// <param name="value">boolean specifying the target status </param>	
	...
	/// </summary>
	/// <param name="value">int specifying the target position </param>
	...
	/// <summary>
	/// This method sets the chosen scenario to the normal Startup Scenario.
	/// </summary>
