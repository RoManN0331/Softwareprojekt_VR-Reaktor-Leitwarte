...
{
    /// <param name="DirectionCueEnabledGlobal">Boolean to enable or disable the red frame indicating the player should turn</param>
    public bool DirectionCueEnabledGlobal = true;
    /// <param name="DirectionCueEnabled">Boolean to enable or disable the red frame indicating the player should turn</param>
    public bool DirectionCueEnabled = true;
    /// <param name="DirectionCueFadeDuration">Float to set the duration of the red frame fade in and out</param>
    ...
    /// <param name="DirectionArrowOnScreen">Boolean to enable or disable the 3D arrow indicating the direction the player should turn</param>
    public bool DirectionArrowOnScreen = true;
    /// <param name="AnzeigenMarkierungEnabled">Boolean to enable or disable the annotation to displays indicating relevant displays and target values</param>
    public bool AnzeigenMarkierungEnabled = true;
    /// <param name="ClipboardHighlightEnabled">Boolean to enable or disable the highlighting of text on clipboards</param>
    ...
    /// <param name="animator"> AnimatorController object used to track the current scenario </param>
...
// This method is used for debugging and therefore not included in the documentation
    ...
    /// <param name="Anzeigeninitialized">Boolean tracking whether the displays have been initialised</param>    
    ...
    *******************************/
    ...
    /// <param name="lastindex"> Integer tracking the previous index of the clipboard text that was highlighted </param>
    private int lastindex = 0;
    /// <param name="GGClipboard">GazeGuidingClipboard</param>
    public GazeGuidingClipboard GGClipboard;
    /// <param name="ClipBoardTextColor"> String to store the color of the clipboard text </param>
    public string ClipBoardTextColor = "<color=#00FF00>";
    /// <param name="lastClipboardName"> String to store the name of the last clipboard that was highlighted </param>
    ...
    /// <summary>
    /// Method to remove highlighting from the clipboard by reinitialising the respective clipboard without any highlighted text. This method is used when the player is no longer looking at the button associated with the clipboard.
    /// </summary>
