...
public class TuerRESET : MonoBehaviour
{
    ...
    /// <param name="isCooldown"> checks if the handle has been used recently </param>
    private bool isCooldown = false;
    /// <param name="isHovering"> checks if the XR interactor is hovering over the handle </param>    
    private bool isHovering = false;
    /// <param name="trigger"> is a reference to an input action</param>
    public InputActionReference trigger;
    /// <param name="nppClient"> is a reference to the NPPClient instance in the scene</param>
    NPPClient nppClient;   
    ...
    /// </summary>
    /// <param name="targetAngle">  specifies the angle to rotate the door handle to</param>
    /// <param name="duration"> specifies the duration of the rotation</param>
