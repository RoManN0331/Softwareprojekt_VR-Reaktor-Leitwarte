...
public class AusfallAnzeigenManager : MonoBehaviour
{
    ...
    /// <param name="ausfallAnzeigen">List of displays signalling whether the assigned components have failed</param>
    public List<AusfallAnzeige> ausfallAnzeigen;
    /// <param name="toChange">Color used for lamps</param>
    ...
    /// </summary>
    /// <param="name">String specifying the name of a component with an assigned display</param>
    ...
    /// <summary>
    /// This method switches off a display for a component.
    /// </summary>
    /// <param="name">String specifying the name of a component with an assigned display</param>
    ...
    /// <summary>
    /// This method switches on all displays added to ausfallAnzeigen.
    /// </summary>
    ...
    /// <summary>
    /// This method switches off all displays added to ausfallAnzeigen.
    /// </summary>
