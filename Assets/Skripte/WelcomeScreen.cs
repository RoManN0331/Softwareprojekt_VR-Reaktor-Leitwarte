...
public class WelcomeScreen : MonoBehaviour
{
    ...
    /// <param name="forwardButton">Button to go to the next page of the welcome message</param>
    public GameObject forwardButton;
    /// <param name="backButton">Button to go to the previous page of the welcome message</param>
    public GameObject backButton;
    /// <param name="confirmButton">Button to close the welcome message</param>
    public GameObject confirmButton;
    /// <param name="scrollPanel">Panel displaying the welcome message</param>
    public GameObject scrollPanel;
    /// <param name="DISABLE_WELCOME_SCREEN">boolean tracking whether the welcome screen is displayed or not</param>
    public bool DISABLE_WELCOME_SCREEN = false;
    /// <param name="clipbaordInputAction">InputActionAsset for retrieving the controller button that used to trigger a chosen scenario</param>
    public InputActionAsset clipbaordInputAction;
    /// <param name="infoTexts">string Array containing the welcome message</param>
