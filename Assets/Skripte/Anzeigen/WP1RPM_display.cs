...
/// <summary>
/// This method initializes the AnzeigeSteuerung component, clientObject and the display by calling the NPPReactorState object in NPPClient to fetch the current RPM of water pump 1.</summary>
/// </summary>
    void Start()
    {
...
/// <summary>
/// This method updates the display by reading the current RPM of water pump 1 from the WP1.rpm field of the NPPReactorState object in NPPClient. 
/// </summary>
    void Update()
    {
        anzeigeSteuerung.CHANGEpercentage = clientObject.GetComponent<NPPClient>().simulation.WP1.rpm / 2000f * 100;
