...
{
    /// <param name="moveSpeed"> sppecifies the speed of vertical movements</param>
    public float moveSpeed = 3f;            
    /// <param name="moveAmount"> specifies the amount of vertical movement</param>
    public float moveAmount = 0.015f;
    /// <param name="fontSizeSpeed"> specifies the speed of the font size change</param>
    public float fontSizeSpeed = 2f;        
    /// <param name="fontSizeAmount"> specifies the amount of font size change</param>
    public float fontSizeAmount = 0.1f;     
    /// <param name="targetNumber"> is used to calculate the position of the arrow pointing to the target value</param>
    public float targetNumber = 1000;
    /// <param name="pfeilTransform"> is a Transfom for animating the arrow pointing to the target value</param>
    private Transform pfeilTransform;
    /// <param name="textMeshPro"> is a TextMeshPro used to mark the display by an "!" </param>
    private TextMeshPro textMeshPro;
    /// <param name="initialY"> specifies the initial y position of the arrow pointing to the target value</param>
    private float initialY;
    /// <param name="initialFontSize"> specifies the initial font size set for the TextMeshPro</param>
    private float initialFontSize;
    /// <param name="xleft"> specifies the leftmost position of the arrow indicating the target value</param>
    private float xleft = 0.0611f;
    /// <param name="xright"> specifies the rightmost position of the arrow indicating the target value</param>
    private float xright = -0.0734f;
    /// <param name="anzeigeSteuerung">is a reference to an AnzeigeSteuerung used to get the upper limit of a display to calculate the target number</param>
    private AnzeigeSteuerung anzeigeSteuerung;
    /// <param name="anzeigeSteuerung2"> is a reference to an AnzeigeSteuerung5 used to get the upper limit of a display to calculate the target number</param>
    private AnzeigeSteuerung5 anzeigeSteuerung2;

    /// <summary>
    /// This method initialises an arrow pointing to the target value, a "!" marking the display and the control component (AnzeigeSteuerung) of the display.
    /// <summary>
    void Start()
    {
